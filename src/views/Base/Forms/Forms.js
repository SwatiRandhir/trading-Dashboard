      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12"  >
            <Card>
              <CardHeader>
                <strong>Strategies Configration</strong>
                {/* <small> Form</small> */}
              </CardHeader>
              <CardBody>
                <Row>
                  <Col xs="4">
                    <FormGroup>
                      <Label htmlFor="name">Please insert your Strategies</Label>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Row>
                  <Col xs="4">
                    <FormGroup>
                      <Label htmlFor="ccmonth">Please insert your Timeframes</Label>
                      <Input type="select" name="ccmonth" id="ccmonth">
                        ...
                        <option value="8">Daily Chart</option>
                        <option value="9">Weekly Chart</option>
                        <option value="10">Monthly Chart</option>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Row>
                  <Col xs="4">
                    <FormGroup>
                      <Label htmlFor="ccmonth">Please insert your Goals</Label>
                      <Input type="select" name="ccmonth" id="ccmonth">
                  ...
                  <Col xs="4">
                    <FormGroup>
                      <Label htmlFor="name">Profile Expected</Label>
                      <Input type="text" id="name" required />
                    </FormGroup>
                  </Col>
                </Row>
